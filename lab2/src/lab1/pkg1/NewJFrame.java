...
if (jTextFieldLow.getText().isEmpty() ||
        ...
        jTextFieldStep.getText().isEmpty()) 
    {
     ...
     lowLim = Double.parseDouble(jTextFieldLow.getText());
     ...
     arrInteg.add(new RecIntegral(lowLim, upLim, step));
    ...
    private void jButtonResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonResultActionPerformed
      ...
      int rowNum = jTable1.getSelectedRow();
        ...
        if (rowNum == -1) {
            ...
            result =   rec. CalcIntegral(rec.getLowLim(), rec.getUpLim(), rec.getStep());
            rec.setResult(result);
              tModel.setValueAt(rec.geResult() , rowNum, 3);
